            ...
            jQuery("#list2").jqGrid(
                    {
                        ...
                        emptyrecords: "当前无记录",
                        colNames: ['ID', '食品名字', '类别', '蛋白质/克', '脂肪/克', '碳水化合物/克','能量/千卡'],//jqGrid的列显示名字
                        colModel: [  //这里会根据index去解析jsonReader中root对象的属性，填充cell
                            {name: 'id', index: 'id', width: 50, sortable: true, search: false},
                            {name: 'fName', index: 'fName', width: 50, sortable: false,search: true,
                                //被该列搜索时的搜索条件有哪些
                            ...
                            {name: 'fParentid', index: 'fParentid', width: 50, sortable: false, search: false},
                            {name: 'fPro', index: 'fPro', width: 50, sortable: false, search: false},
                            {name: 'fFat', index: 'fFat', width: 50, sortable: false, search: false},
                            {name: 'fCar', index: 'fCar', width: 50, sortable: false, search: false},
                            {name: 'fEne', index: 'fEne', width: 50, sortable: false, search: false},
